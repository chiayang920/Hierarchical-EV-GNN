#!/usr/bin/env python3
"""Prepare one Formal-75k diagnostic cell's schema-v3 reconciliation evidence."""
...
from scripts.formal_75k_80cell_workflow import resolve_formal_cell
...
def prepare_validation(
    *,
    ...
    service_reconciliation = build_service_reconciliation_rows(
        diagnostic_rows, transformer_rows, charger_rows
    )
    ...
    atomic_write_csv_rows(
        ...
        [
            ...
            "discharged_energy_reconciliation_status", "episode_total_ev_served",
            "charger_served_ev_count_sum", "transformer_served_ev_count_sum",
            "episode_total_energy_charged", "charger_energy_charged_kwh_sum",
            "transformer_energy_charged_kwh_sum", "episode_total_energy_discharged",
            "charger_energy_discharged_kwh_sum", "transformer_energy_discharged_kwh_sum",
        ],
    ...
    if hard_failures:
        raise ValueError(f"Formal-75k diagnostic reconciliation failed: {summary}")
    return summary
